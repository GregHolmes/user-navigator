...
<script src="<?php echo base_url(); ?>assets/vendors/bower_components/lightgallery/light-gallery/js/lightGallery.min.js"></script>
                ...
                <div class="container">
                    ...
                    <div class="block-header">
                        ...
                        <ul class="actions">
                            ...
                            <button class="btn bgm-green btn-float waves-effect" id="showcustom"><i class="zmdi zmdi-mail-send"></i></button>     
                        </ul>
                    </div>
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCdk1XYllFRIzIRXuSZ9c_04kPV_ZfBJOg&signed_in=true&libraries=geometry,places,drawing&callback=initMap">
    ...
    function showmap(pid,lat,lng)
              {
                    ...
                    if (event.type == google.maps.drawing.OverlayType.MARKER) {
                        ...
                        var EditForm = '<p><div class="marker-edit">' +
                            ...
                            '<div class="form-group"><div class="fg-line"><div class="select"><select id="pType" class="form-control"><option value="transport">Speed Breaker</option></select></div></div></div>'+
                            '</div></p><button type="submit" name="save-marker" class="save-marker btn btn-success btn-xs">Save</button>'+
                            '</form>';

                        //Drop a new Marker with our Edit Form
                        create_marker(lat, lng, 'Add Speed Breaker', EditForm, true, true, true, "<?= base_url();?>assets/img/map-icons/transport.png");
