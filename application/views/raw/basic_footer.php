<footer id="footer">
            Copyright &copy; <?php echo date('Y'); ?> | User Navigation System
            
            <ul class="f-menu">
                <li><strong>Project Done By: </strong></li>
                <li><a target="_blank" href="https://fb.me/akashedattel">Akash Giby</a></li>
                <li><a target="_blank" href="https://fb.me/akhiljose009">Akhil Jose</a></li>
                <li><a target="_blank" href="https://fb.me/amalmurali47">Amal Murali</a></li>
                <li><a target="_blank" href="https://fb.me/tompadam17">Tom George</a></li>
            </ul>
        </footer>
        ...
        <script src="<?php echo base_url(); ?>assets/vendors/bootstrap-wizard/jquery.bootstrap.wizard.min.js"></script>
