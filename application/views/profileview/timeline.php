                ...
                <ul class="actions m-t-20 hidden-xs">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a href="#" data-id="<?= $feed->checkin_id; ?>" id="checkin-Hide">Hide</a>
                            </li>
                        </ul>
                    </li>
                </ul>
...
$('body').on('click', '#checkin-Hide', function(e) {   
            var checkin_id = $(this).attr("data-id"); 
                        ...
                        notify(nFrom, nAlign, nIcons, nType, nAnimIn, nAnimOut, 'Story Hidden');
                        $( "#clear" ).click();
